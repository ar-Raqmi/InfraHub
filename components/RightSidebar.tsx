...
const RightSidebar: React.FC<RightSidebarProps> = ({ projects }) => {
  ...
  return (
    <>
      {/* Orange Card - Summary */}
      <div className="rounded-3xl p-4 md:p-5 bg-orange-500  text-white shadow-lg shadow-orange-500/20">
        ...
        <div className="mt-4 flex items-center gap-2 bg-white/15 p-1 rounded-full">
          <div className="flex-1 px-3 py-1.5 rounded-full text-sm bg-white  text-zinc-900  font-geist text-center font-medium shadow-sm">
            Aktif
          </div>
      ...
      {/* Cyan Card - Tasks */}
      <div className="rounded-3xl p-4 md:p-5 bg-cyan-400  text-zinc-900 shadow-lg shadow-cyan-400/20">
        <div className="flex items-start justify-between">
          <div>
            <h3 className="text-lg tracking-tight font-semibold font-geist">Tugasan</h3>
            <p className="text-sm text-zinc-700  mt-1 font-geist">Tindakan perlu diambil</p>
          </div>
        ...
        <div className="mt-4">
          <div className="text-xs uppercase tracking-wide text-zinc-700  font-geist mb-2">Status Kelulusan</div>
        ...
        <div className="mt-4 flex items-center gap-2">
          <button className="flex-1 flex gap-2 hover:opacity-95 text-white bg-zinc-900 rounded-2xl pt-3 pr-4 pb-3 pl-4 shadow-lg items-center justify-center transition-colors">
