...
const CoverPageEditor: React.FC<CoverPageEditorProps> = ({ project, selectedYear, pjaUser, onUpdate, isPrintView }) => {
    ...
    return (
        <div className="flex flex-col gap-6 w-full max-w-[210mm] mx-auto">
            ...
            {/* PREVIEW CONTAINER */}
            <div className={`flex flex-col items-center bg-gray-100  py-8 overflow-hidden rounded-2xl border border-slate-200  shadow-inner ${!isPrintView ? 'hidden' : ''}`}>
                <div id="cover-page-doc" className="origin-top transition-transform">
                    ...
                    <div className="w-[210mm] mx-auto mb-10 shadow-2xl print:shadow-none print:mb-0">
                        <div 
                            className="w-full h-[290mm] bg-white text-black  p-[20mm] relative box-border mx-auto leading-normal flex flex-col justify-between pdf-page print:h-[296mm]"
                        ...
                        >
                            <div>
                                ...
                                <div className="flex items-start justify-between mb-6">
                                    ...
                                    <div className="flex-1 text-center px-4">
                                        <h2 className="text-[16px] font-bold uppercase tracking-wide text-black">JABATAN KEJURUTERAAN</h2>
                                        <h1 className="text-[18px] font-bold uppercase tracking-wide mb-1 text-black">MAJLIS PERBANDARAN SELAYANG</h1>
                                        ...
                                        <div className="mt-4 text-[16px] font-bold uppercase italic underline text-black">
                                            CADANGAN KERJA
                                        </div>
                                    </div>
                                ...
                                {/* TABLE */}
                                <table className="w-full border-collapse border border-black text-[13px] mb-6 table-fixed text-black">
                                    <tbody>
                                        <tr>
                                            <td className="border border-black p-2 w-[30%] align-top font-bold text-black">Tarikh</td>
                                            <td className="border border-black p-2 align-top font-bold text-black">
                                                <span className="pl-12">{formattedDate}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td className="border border-black p-2 align-top font-bold text-black">Daripada</td>
                                        ...
                                        <tr>
                                            <td className="border border-black p-2 align-top font-bold text-black">Kepada</td>
                                            <td className="border border-black p-2 align-top text-black">
                                                Pengarah<br/>
                                        ...
                                        <tr>
                                            <td className="border border-black p-2 align-top font-bold text-black">Tajuk</td>
                                            <td className="border border-black p-2 align-top font-bold uppercase text-justify text-black">
                                                {project.namaProjek}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td className="border border-black p-2 align-top font-bold text-black">Blok Perancangan</td>
                                            <td className="border border-black p-2 align-top text-black">
                                                {project.bp}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td className="border border-black p-2 align-top font-bold text-black">Zon</td>
                                            <td className="border border-black p-2 align-top text-black">
                                                {project.zon}
                                            </td>
                                        </tr>
                                ...
                                {/* BODY TEXT */}
                                <div className="text-[13px] leading-relaxed mb-6 text-justify text-black">
                                    ...
                                    <p className="mt-8 text-black">Sekian, terima kasih.</p>
                                    
                                    <div className="mt-8 font-bold text-[12px] space-y-1 text-black">
                            ...
                            {/* FOOTER / SIGNATURE */}
                            <div className="text-[13px] mt-auto text-black">
                                ...
                                <div className="text-black">{jawatan},</div>
                                <div className="text-black">{bahagian},</div>
                    ...
                    <div className="w-[210mm] mx-auto shadow-2xl print:shadow-none print:mb-0">
                        <div className="w-full h-[290mm] bg-white text-black  p-[20mm] relative box-border mx-auto leading-normal pdf-page print:h-[296mm]" style={{ fontFamily: 'Arial, sans-serif' }}>
                            <div className="border border-black h-full flex flex-col">
                                ...
                                <div className="flex-1 border-b border-black p-6 relative flex flex-col">
                                    <h3 className="font-bold uppercase mb-4 text-[14px] text-black">ULASAN JURUTERA</h3>
                                    <p className="text-justify mb-8 uppercase leading-relaxed text-[13px] font-bold text-black">{project.namaProjek}</p>
                                    
                                    <div className="grid grid-cols-[150px_20px_1fr] gap-y-4 mb-10 text-[13px] text-black">
