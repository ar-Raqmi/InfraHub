                        ...
                        <div className="flex gap-3 mb-2">
                            ...
                            <div className="flex-1 pl-10">
                                ...
                                <div className="mt-2 flex items-center gap-2">
                                    ...
                                    {item.isAdjustment ? (
                                        <DimensionInput value={item.rate} onChange={(val) => updateItem(bill.id, item.id, { rate: val })} disabled={readOnly} className="text-xs bg-blue-50 px-2 py-0.5 rounded text-blue-600 font-mono w-20 outline-none border border-blue-100" />
                                    ) : (
