      ...
      <div className="w-full md:w-1/3 glass-effect rounded-3xl shadow-xl border border-white/20 dark:border-white/5 overflow-hidden flex flex-col">
        <div className="p-4 border-b border-slate-100 dark:border-white/5">
          <div className="relative">
            ...
            <input type="text" placeholder="Cari emel..." className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border-0 text-sm focus:ring-2 focus:ring-indigo-500 text-slate-900 dark:text-white" />
          </div>
        </div>
        <div className="flex-1 overflow-y-auto">
          {emails.map(email => (
            <div key={email.id} className={`p-4 border-b border-slate-50 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 cursor-pointer transition-colors ${email.unread ? 'bg-indigo-50/50 dark:bg-indigo-900/10' : ''}`}>
      ...
      <div className="hidden md:flex flex-1 glass-effect rounded-3xl shadow-xl border border-white/20 dark:border-white/5 flex-col">
        ...
        <div className="p-8 flex-1 overflow-y-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold">PJ</div>
            <div>
