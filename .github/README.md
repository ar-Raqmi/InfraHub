<p align="center">
  <img src="../images/icon.svg" alt="InfraHub Logo" width="120" />
</p>

<h1 align="center">InfraHub</h1>

<p align="center">
  <strong>Sistem Pengurusan Projek Infrastruktur (Infrastructure Project Management System)</strong><br />
  Designed and built for the Engineering Department of <strong>Majlis Perbandaran Selayang (MPS)</strong>.
</p>

<p align="center">
  <a href="#-about-infrahub">About</a> •
...
**InfraHub** is a comprehensive, modern infrastructure project management system tailored specifically for the engineering department of **Majlis Perbandaran Selayang**. It streamlines the lifecycle of municipal construction and maintenance projects from initial Bill of Quantities (BQ) drafting, through company appointments, execution tracking, site inspection, to final payment processing and closure.

<p align="center">
  <img src="../images/dashboard.png" alt="InfraHub Dashboard" width="700" style="border-radius:12px; border: 1px solid #e2e8f0;" />
</p>
...
* **🔐 Login (`Login.tsx`)**
  * Secure user authentication with role-based access control (Admin, PJA, Jurutera) to restrict system actions.
...
* **📂 Project List (`ProjectsList.tsx`)**
  * An interactive repository of all infrastructure projects. Supports comprehensive filtering by status, PJA, zone and budget category, with options to export project metadata.
...
| **PJA (Penolong Jurutera)** | Drafts BQs, updates site metrics, uploads inspections photos and compiles payment claims. |
...
Every infrastructure project in InfraHub progresses through **6 structured phases**:
...
* **In-Charge**: PT Syafiq (Unit Selenggara Infrastruktur)
